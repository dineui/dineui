...
export function useButtonStyle(useButtonStyleProps: UseButtonStyleProps): CSSObject {
  const theme = {
    colors: { brandAlt400: '', transparent: '', test500: '', white: '', test300: '', test200: '' },
    text: { normal200: {}, medium300: {} },
  }
